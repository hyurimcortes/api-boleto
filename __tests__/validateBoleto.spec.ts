...
import { ConsultaBoletoUseCase } from "../src/app/services/boleto/ConsultaBoletoUseCase";
...
describe('Boleto (Validação)', () => {
    it('Boleto bancário é válido.', () => {
        const boleto = new ConsultaBoletoUseCase();
        const boletoObj = boleto.execute("34191790010104351004791020150008987820026300")
        const boletoObjMock = {
    ...
    it('Boleto bancário é inválido. (digito verificador)', () => {
        const boleto = new ConsultaBoletoUseCase();
        const boletoObj = boleto.execute('34191.79002 01043.510047 91020.150008 9 87820026300')
        const boletoObjMock = {
    ...
    it('Boleto bancário é ConsultaBoletoUseCase. (linha digitavel < 44)', () => {
        const boleto = new ConsultaBoletoUseCase();
        const boletoObj = boleto.execute('34191.79001 01043.510047 91020.150008 87820026300')
        const boletoObjMock = {
    ...
    it('Boleto concessionárias é válido.', () => {
        const boleto = new ConsultaBoletoUseCase();
        const boletoObj = boleto.execute('83680000003-3 00230048100-5 22218056921-2 00183609383-9')
        const boletoObjMock = {
    ...
    it('Boleto concessionárias é inválido.', () => {
        const boleto = new ConsultaBoletoUseCase();
        const boletoObj = boleto.execute('83680000003 00230048100-5 22218056921-2 00183609383-9')
        const boletoObjMock = {
